...
import java.net.URL;
public class TestSearchFieldTest {
  ...
  public void testSearchField() {
    ...
    driver.findElement(By.name("filter_search")).click();
    driver.findElement(By.name("filter_search")).sendKeys("platform");
    driver.findElement(By.id("button-search")).click();
    assertThat(driver.findElement(By.linkText("PayPal Commerce Platform Integration")).getText(), is("PayPal Commerce Platform Integration"));
  }
}
